...
def hebrew_delay_1(year):
    ...
    #print('months', months, 'parts', parts, 'day', day)
...
def hebrew_to_jd(year, month, day):
    ...
    #print('HEBREW_EPOCH', HEBREW_EPOCH)
    #print('year)', year)
    #print('hebrew_delay_1(year)', hebrew_delay_1(year))
    #print('hebrew_delay_2(year)', hebrew_delay_2(year))
    #print('day', day)
    #print('jd', jd)
...
def jd_to_hebrew(jd):
    ...
    year = count - 1;
    i = count
    #print('hebrew_to_jd', hebrew_to_jd(i, 7, 1))
    ...
    while jd > hebrew_to_jd(year, i, hebrew_month_days(year, i)):
        ...
        month += 1
    #print(month)
    #print('hebrew_to_jd', hebrew_to_jd(year, month, 1))
